...
describe("useDeeplink hook", () => {
	...
	it("should handle url", async () => {
		...
		expect(router.state.location.pathname + router.state.location.search).toBe(
			"/profiles/877b7695-8a55-4e16-a7ff-412113131856/dashboard?method=transfer&method=transfer&network=mainsail.devnet&recipient=0xcd15953dD076e56Dc6a5bc46Da23308Ff3158EE6&amount=1.2&memo=ARK",
		);
	});
});
