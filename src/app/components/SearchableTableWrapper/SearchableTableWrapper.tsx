			...
			<div className="border-theme-secondary-300 dark:border-theme-secondary-800 md:overflow-hidden md:rounded-xl md:border">
				<div className="flex flex-col">
					<div
						...
						className="border-theme-secondary-300 dark:border-theme-secondary-800 relative flex items-center overflow-hidden rounded border border-b md:rounded-none md:border-x-0 md:border-t-0"
					>
