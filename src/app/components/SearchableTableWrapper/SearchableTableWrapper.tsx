			...
			<div className="border-theme-secondary-300 dark:border-theme-secondary-800 dim:border-theme-dim-700 md:overflow-hidden md:rounded-xl md:border">
				<div className="flex flex-col">
					<div
						...
						className="border-theme-secondary-300 dark:border-theme-secondary-800 dim:border-theme-dim-700 relative hidden items-center overflow-hidden rounded border border-b px-6 py-4 md:flex md:rounded-none md:border-x-0 md:border-t-0"
					>
