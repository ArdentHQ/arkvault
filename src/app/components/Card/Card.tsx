						...
						toggleContent={
							<div className="flex w-4 justify-center overflow-hidden">
								<Icon
									...
									className="text-theme-primary-300 hover:text-theme-primary-400 dark:text-theme-secondary-600 dark:hover:text-theme-secondary-200 cursor-pointer p-1 transition-colors duration-200"
									size="md"
								/>
							</div>
						}
