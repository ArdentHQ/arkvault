			...
			>
				<Dropdown
					...
					toggleContent={(isOpen) => (
						<button
							type="button"
							className="flex h-7 cursor-pointer items-center rounded-xs text-theme-secondary-700 focus:outline-hidden focus:ring-2 focus:ring-theme-primary-400 dark:text-theme-dark-200"
						>
