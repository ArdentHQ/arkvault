	...
	<button
		...
		className={twMerge(
			...
			cn({
				...
				"text-theme-secondary-500 hover:bg-theme-primary-200 hover:text-theme-primary-700 focus:ring-theme-primary-400 dark:text-theme-dark-50 dark:hover:bg-theme-dark-700 focus:rounded-xs focus:ring-2 focus:outline-hidden focus:ring-inset":
					!disabled,
			}),
			props.className,
		)}
