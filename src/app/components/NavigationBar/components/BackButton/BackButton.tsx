	...
	<button
		...
		className={twMerge(
			...
			cn({
				...
				"text-theme-secondary-500 hover:bg-theme-primary-200 hover:text-theme-primary-700 focus:rounded-xs focus:outline-hidden focus:ring-2 focus:ring-inset focus:ring-theme-primary-400 dark:text-theme-dark-50 dark:hover:bg-theme-dark-700":
					!disabled,
			}),
			props.className,
		)}
