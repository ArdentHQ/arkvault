...
const StyledBackButton = ({
	...
	<button
		{...props}
		className={twMerge(
			"flex w-9 items-center bg-theme-secondary-100 transition-colors duration-200 dark:bg-theme-dark-950 border-b border-b-theme-secondary-300 dark:border-b-theme-dark-700",
			cn({
