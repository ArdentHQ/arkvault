...
interface SearchBarInputWrapperProperties extends React.HTMLProps<HTMLDivElement> {
	ref?: React.Ref<HTMLDivElement>;
}

const SearchBarInputWrapper = (properties: SearchBarInputWrapperProperties) => (
	<div
		{...properties}
		className={twMerge(
