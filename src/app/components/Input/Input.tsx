				...
				<div className={cn("relative flex h-full flex-1", { invisible: hideInputValue })}>
					{showFakePasswordField && (
						<input
							...
							className={cn(
								"font-password-mask pointer-events-none absolute inset-0 border-0 bg-transparent p-0! ring-0 outline-none",
					...
					<InputStyled
						...
						className={cn(
							...
							{
								"caret-theme-text no-selection-style font-password-mask text-transparent":
									showFakePasswordField,
								"text-theme-secondary-text": disabled,
							},
							innerClassName,
