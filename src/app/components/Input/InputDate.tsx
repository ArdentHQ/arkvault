								...
								addons={{
										...
										content: (
											<button
												...
												className="ring-focus relative flex h-full w-full items-center justify-center text-2xl text-theme-secondary-700 focus:outline-hidden dark:text-theme-secondary-200"
