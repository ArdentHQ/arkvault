...
export const Notifications = ({ profile, onTransactionClick, hideDropdown }: NotificationsProperties) => {
	...
	return (
		<div
			className="dark:bg-theme-dark-900 dim:bg-theme-dim-700 w-full sm:w-[35rem]"
			data-testid="NotificationsWrapper"
		>
			<div className="flex items-center justify-between px-6 py-4 bg-theme-secondary-100 dim:bg-theme-dim-950 rounded-t-xl dark:bg-black">
			...
			{transactions.length === 0 && (
				<div className="px-6 pt-4 pb-8">
					...
					<div className="w-full mt-8 mb-2">
						<Image name="EmptyNotifications" className="w-full mx-auto sm:w-64" />
					</div>
				</div>
			)}
