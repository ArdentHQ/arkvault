...
const renderOptionGroup = ({ key, hasDivider, title, options, onSelect }: DropdownOptionGroup) => {
	...
	return (
		<div key={key}>
			...
			<ul>
				{title && (
					<li className="mx-1 my-1 block whitespace-nowrap rounded-lg bg-theme-primary-50 px-8 py-1 text-left text-xs font-semibold text-theme-secondary-700 dark:bg-theme-dark-800 dark:text-theme-dark-200">
						{title}
					</li>
				)}
