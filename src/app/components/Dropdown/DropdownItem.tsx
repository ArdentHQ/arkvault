...
export const DropdownItem = ({
	...
	<li
		{...props}
		className={twMerge(
			"focus:outline-hidden flex items-center whitespace-nowrap text-left text-base font-semibold transition-colors-shadow duration-100 focus:ring-2 focus:ring-inset focus:ring-theme-primary-400",
			cn({
