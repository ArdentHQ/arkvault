...
export const DropdownItem = ({ isActive, ...props }: { isActive: boolean } & React.HTMLProps<HTMLLIElement>) => (
	<li
		{...props}
		className={twMerge(
			"flex items-center space-x-2 whitespace-nowrap border-l-4 px-8 py-4 text-left text-base font-semibold transition-colors-shadow duration-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-theme-primary-400",
			cn({
