...
const FormButtonsWrapper = ({
	...
	<div
		{...props}
		className={twMerge(
			"fixed inset-x-0 bottom-0 z-50 flex gap-3 border-t border-theme-secondary-300 bg-theme-background px-8 py-3 dim:border-theme-dim-700 dim:bg-theme-dim-950 dark:border-theme-dark-700 dark:bg-theme-dark-950 sm:relative sm:inset-auto sm:mt-6 sm:justify-end sm:bg-transparent sm:p-0 sm:shadow-none sm:dim:bg-transparent sm:dark:bg-transparent sm:dark:shadow-none [&>button]:flex-1 sm:[&>button]:flex-none",
