...
const FormButtonsWrapper = ({
	...
	<div
		...
		className={twMerge(
			...
			"[.modal-footer_&]:mt-4 [.modal-footer_&]:1border-none [.modal-footer_&]:-mx-6 [.modal-footer_&]:px-6 [.modal-footer_&]:sm:border-t [.modal-footer_&]:sm:pt-6",
			cn({
...
const FormButtons: React.FC<{
	...
	return <FormButtonsWrapper showMobileNavigation={showMobileNavigation} className={className}>{children}</FormButtonsWrapper>;
};
