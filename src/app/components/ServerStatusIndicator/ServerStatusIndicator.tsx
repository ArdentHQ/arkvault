		...
		<div>
					...
					<NavigationButtonWrapper className="group">
						<Tooltip content={t("COMMON.NETWORK_STATUS")}>
							...
							>
								...
								<div className="absolute top-0 right-0 flex items-center justify-center p-1 transition-all duration-100 ease-linear rounded-full">
			...
			>
				<div className="w-full sm:w-128">
					<div className="flex items-center justify-between w-full px-8 py-4 bg-theme-secondary-100 dim:bg-theme-dim-950 rounded-t-xl dark:bg-black">
					...
					<div className="flex items-start px-8 py-4 space-x-2 text-theme-text">
						<div className="flex items-center justify-center p-1 mt-1 transition-all duration-100 ease-linear rounded-full bg-theme-background dark:group-hover:bg-theme-secondary-800 group-hover:bg-theme-primary-100 dim:text-theme-dim-200">
							<StatusDot status={status.value} />
						</div>
