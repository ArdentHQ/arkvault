...
export const Checkbox = ({ color = "success", ref, ...props }: CheckboxProperties) => {
	...
	return (
		<input
			...
			disabled={disabled}
			className={twMerge(
				"custom-checkbox focus:ring-theme-primary-400! h-5! w-5! rounded! border-2! focus:ring-offset-0! cursor-pointer transition duration-150 ease-in-out",
				...
				"disabled:cursor-not-allowed disabled:border-theme-secondary-300 disabled:bg-theme-secondary-200 disabled:checked:border-theme-secondary-300 disabled:checked:bg-theme-secondary-200 disabled:checked:text-theme-secondary-300 dim:disabled:border-theme-dim-600 dim:disabled:bg-theme-dim-800 dim:disabled:checked:border-theme-dim-600 dim:disabled:checked:bg-theme-dim-800 dim:disabled:checked:text-theme-dim-600 dark:disabled:border-theme-dark-600 dark:disabled:bg-theme-dark-800 dark:disabled:checked:border-theme-dark-600 dark:disabled:checked:bg-theme-dark-800 dark:disabled:checked:text-theme-dark-600",
				cn({
					"not-checked:hover:border-theme-danger-500 checked:text-theme-danger-500 checked:hover:text-theme-danger-600 dim:checked:border-theme-danger-400 dim:checked:hover:text-theme-danger-500 dark:checked:border-theme-danger-400 dark:checked:hover:text-theme-danger-500":
