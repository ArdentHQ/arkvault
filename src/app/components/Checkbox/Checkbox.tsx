	...
	return (
		<input
			...
			className={twMerge(
				...
				"disabled:cursor-not-allowed disabled:border-theme-secondary-300 disabled:bg-theme-secondary-200 disabled:dark:border-theme-dark-600 disabled:dark:bg-theme-dark-800 disabled:checked:border-theme-secondary-300 disabled:checked:bg-theme-secondary-200 disabled:checked:text-theme-secondary-300 disabled:checked:dark:border-theme-dark-600 disabled:checked:dark:bg-theme-dark-800 disabled:checked:dark:text-theme-dark-600",
				cn({
					"checked:text-theme-danger-500 checked:hover:text-theme-danger-600 [&:not(:checked)]:hover:border-theme-danger-500 dark:checked:border-theme-danger-400 dark:checked:hover:text-theme-danger-500":
					...
					"checked:text-theme-primary-600 [&:not(:checked)]:hover:border-theme-primary-600":
						color === "info" && !disabled,
					"checked:text-theme-primary-600 checked:hover:text-theme-primary-700 [&:not(:checked)]:hover:border-theme-primary-600 dark:[&:not(:checked)]:hover:border-theme-dark-navy-500 checked:dark:checked:text-theme-dark-navy-500 checked:dark:hover:text-theme-dark-navy-600":
