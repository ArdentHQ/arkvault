...
export const Checkbox =	forwardRef<HTMLInputElement, CheckboxProperties>(({ color = "success", ...props }, ref) => <input type="checkbox" ref={ref} className={twMerge("!w-5 !h-5 !rounded cursor-pointer !border-2 transition duration-150 ease-in-out focus:!ring-offset-0 focus:!ring-theme-primary-400 disabled:bg-theme-secondary-200 disabled:border-theme-secondary-300 disabled:cursor-not-allowed disabled:dark:bg-theme-secondary-800 disabled:dark:border-theme-secondary-600 [&:not(:checked)]:!bg-transparent [&:not(:checked)]:border-theme-secondary-300 [&:not(:checked)]:dark:border-theme-secondary-600 custom-checkbox", cn({
