...
export const TableWrapper = ({ className, children, noBorder = false, ...properties }: TableWrapperProps) => (
	<div
		...
		className={cn(
			"rounded-xl pb-2 outline outline-1 outline-transparent md:outline-theme-secondary-300 dim:md:border-theme-dim-700 dim:md:outline-theme-dim-700 dark:md:border-theme-secondary-800 dark:md:outline-theme-secondary-800",
			{
