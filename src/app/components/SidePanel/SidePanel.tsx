									...
									>
										<div
											...
											className={cn(
												...
												{
													"border-theme-secondary-300 dark:border-theme-dark-700 dim:border-theme-dim-700 overflow-hidden rounded-tl-sm sm:rounded-tl-xl border-t border-l border-r sm:border-r-0 rounded-tr-sm sm:rounded-tr-none":
														isMinimized,
