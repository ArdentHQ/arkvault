...
export const SelectProfileImage = ({ value, onSelect }: SelectProfileImageProperties) => {
	...
	const renderButton = () => {
			...
			return (
				<div className="relative z-0 h-[92px] w-[92px]">
					<ProfileImageStyled>
						...
						<button
							type="button"
							className="focus:outline-hidden absolute z-10 h-full w-full overflow-hidden p-1 opacity-0 transition-opacity duration-200"
		...
		return (
			<div className="h-[92px] w-[92px] rounded-lg border border-theme-secondary-300 p-1.5 focus-within:border-solid focus-within:border-theme-primary-400 dim:border-theme-dim-700 dark:border-theme-dark-700">
