...
export const ValidatorFooter = ({
	...
	return (
		<div
			className="dark:bg-dark-700 fixed inset-x-0 bottom-0 mb-14 h-auto w-screen border-t border-theme-secondary-300 bg-theme-background py-3 dim:border-theme-dim-700 dark:border-theme-dark-700 sm:mb-0"
		...
		>
			<div className="mx-auto px-8 lg:container md:px-10">
				<div className="flex flex-col font-semibold sm:flex-row sm:space-x-3">
					<div className="hidden grow divide-theme-secondary-300 overflow-x-auto dim:divide-theme-dim-700 dark:divide-theme-secondary-800 sm:mr-auto sm:divide-x md:flex">
					...
					<div className="flex flex-1 flex-col items-center justify-center sm:flex-row">
						<div className="flex flex-1 items-center sm:-ml-6 md:ml-0 md:flex-none">
							...
							<span className="block h-5 w-px bg-theme-secondary-300 dim:bg-theme-dim-700 dark:bg-theme-secondary-800 md:hidden lg:block" />
						...
						<div className="w-full pt-3 sm:flex sm:w-auto sm:items-center sm:pt-0">
							<span className="hidden h-5 w-px bg-theme-secondary-300 dim:bg-theme-dim-700 dark:bg-theme-secondary-800 md:block" />
