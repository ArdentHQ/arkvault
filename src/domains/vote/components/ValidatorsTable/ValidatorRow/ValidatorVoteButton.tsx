...
const CompactButton = ({ index, disabled, compactClassName, onClick, children }: VoteButtonProperties) => (
	<Button
		...
		disabled={disabled}
		className={cn(
			"-mr-3 w-auto rounded-xs py-0 text-sm leading-[17px] text-theme-primary-600 hover:text-theme-primary-700 hover:underline dark:hover:text-theme-primary-500",
			compactClassName,
		)}
		onClick={onClick}
