...
export const VotesFilter = ({
	...
	return (
		<div {...properties} className="mr-6 hidden md:block">
			...
			>
				<div className="flex w-56 flex-col items-start space-y-5 px-10 py-7 text-theme-secondary-700 dim:text-theme-dim-200 dark:text-theme-secondary-200">
					<label
