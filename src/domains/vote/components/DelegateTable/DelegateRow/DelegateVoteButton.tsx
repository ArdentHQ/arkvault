...
const CompactButton = ({ index, disabled, compactClassName, onClick, children }: VoteButtonProperties) => (
	<Button
		...
		disabled={disabled}
		className={cn(
			"-mr-3 w-full rounded-none py-3 text-sm leading-[17px] text-theme-primary-600 hover:text-theme-primary-700 hover:underline dark:hover:text-theme-primary-500 sm:w-auto sm:rounded sm:py-0",
			compactClassName,
		)}
		onClick={onClick}
