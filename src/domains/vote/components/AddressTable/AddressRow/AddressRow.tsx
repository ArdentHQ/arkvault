			...
			>
				...
				<div className="w-40 flex-1">
					<Address
						address={wallet.address()}
						walletName={alias}
						walletNameClass="text-theme-primary-700 hover:border-current border-b border-transparent transition-[color,border-color] duration-[200ms,350ms] delay-[0s,100ms]"
					/>
				</div>
			</TableCell>
