			...
			>
				...
				<div className="w-40 flex-1">
					<Address
						address={wallet.address()}
						walletName={alias}
						walletNameClass="text-theme-primary-700 transition hover:border-current border-b border-transparent transition-property[color, border-color] transition-duration[200ms, 350ms] delay-100"
					/>
				</div>
			</TableCell>
