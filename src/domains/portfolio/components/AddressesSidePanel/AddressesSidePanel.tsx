						...
						>
							<Button
								...
								className={cn(
									...
									{
										"ring-theme-primary-400 ring-offset-theme-secondary-100 dark:ring-theme-primary-800 dark:ring-offset-theme-dark-950 ring ring-offset-4 sm:ring-offset-transparent dark:sm:ring-offset-transparent":
											showManageHint,
									},
								)}
							>
