...
const Option = ({ option, onSelect }: { option: ImportOption; onSelect: (option: ImportOption) => void }) => (
	...
	>
		<div className="flex items-center space-x-3 m-0 sm:mb-2">
			{option.icon && (
			...
			<div className="text-theme-primary-600 dark:text-theme-dark-50 group-hover:text-theme-primary-700 dim:text-theme-dim-50 dim:group-hover:text-white leading-5 font-semibold dark:group-hover:text-white text-sm sm:text-base">
				{option.label}
			</div>
		</div>
		{option.description && (
