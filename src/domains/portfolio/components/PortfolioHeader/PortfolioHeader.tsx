							...
							<div className="flex flex-row items-center gap-3">
								{selectedWallets.length === 1 && (
									<Button
										...
										className="dark:bg-theme-dark-navy-500 dark:hover:bg-theme-dark-navy-700 dim:bg-theme-dim-navy-700 my-auto flex-1 px-8"
										disabled={
											wallet.balance() === 0 ||
								...
								{selectedWallets.length > 1 && (
									<Button
										data-testid="WalletHeader__send-button"
										className="dark:bg-theme-dark-navy-500 dark:hover:bg-theme-dark-navy-700 dim:bg-theme-dim-navy-600 dim-hover:bg-theme-dim-navy-700 my-auto flex-1 px-8"
