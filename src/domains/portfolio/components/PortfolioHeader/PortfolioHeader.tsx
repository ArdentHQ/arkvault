					...
					>
						<div
							className={cn("flex h-fit flex-row items-center gap-1", {
								"ring-theme-primary-400 dark:ring-theme-primary-800 dark:ring-offset-theme-dark-950 rounded ring ring-offset-4 ring-offset-transparent dark:sm:ring-offset-transparent":
									showHint,
							})}
						>
