	...
	return (
		<div className="flex-col">
			...
			<div className="flex items-center space-x-3">
				<div className="rounded-xl border border-theme-secondary-300 p-8 dark:border-theme-dark-700">
					<h3 className="leading-7.5 mb-2 text-2xl font-semibold text-theme-secondary-900 dark:text-theme-dark-50">
				...
				<div className="rounded-xl border border-theme-secondary-300 bg-theme-primary-100 p-8 dark:border-theme-dark-700 dark:bg-theme-dark-800">
					<h3 className="leading-7.5 mb-2 text-2xl font-semibold text-theme-primary-900 dark:text-theme-dark-50">
...
export const DashboardEmpty = () => (
	<div className="flex items-center justify-center">
		<div className="flex h-page max-w-[724px] items-center">
