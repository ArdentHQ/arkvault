...
export const AddressActionsMenuMobile = () => {
	...
	return (
		<>
			<div className="border-theme-secondary-300 shadow-footer-smooth dark:shadow-footer-smooth-dark fixed bottom-14 left-0 z-10 flex w-full flex-col justify-center border-b bg-white sm:hidden dark:bg-black">
