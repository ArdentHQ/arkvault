export const translations = {
	...
	WALLET_CONTROLS: {
		CREATE: "Create",
		CREATE_ADDRESS_DESCRIPTION: "Create a new address to manage and store your funds. Be sure to securely save the generated passphrase.",
		...
		IMPORT: "Import",
		IMPORT_ADDRESS_DESCRIPTION: "Import your address by entering your mnemonic, using a Ledger hardware wallet, or providing your public address.",
