		...
		<div>
			{showInstallBanner && (
				<div
					...
					className="bg-theme-primary-50 text-theme-secondary-900 dark:bg-theme-secondary-800 fixed bottom-0 left-1/2 z-50 flex w-full -translate-x-1/2 flex-col items-stretch overflow-hidden px-8 sm:flex-row sm:px-0 md:mb-4 md:max-w-xl md:rounded-xl"
				>
					<button
						data-testid="InstallPWA__close"
						type="button"
						onClick={hideInstallBanner}
						className="text-theme-primary-600 hover:bg-theme-primary-100 hover:text-theme-primary-700 dark:hover:bg-theme-secondary-900 flex shrink-0 items-center justify-center p-4"
					>
						<Icon name="Cross" size="md" />
					</button>

					<div className="mb-4 sm:mb-0 sm:py-4">
						<div className="border-theme-secondary-300 dark:border-theme-secondary-700 w-full border-b sm:h-full sm:w-auto sm:border-l" />
					</div>

					<div className="text-theme-text mx-auto flex max-w-60 flex-grow flex-col justify-center text-center sm:max-w-full sm:px-4 sm:text-left">
						<div>
