		...
		<div>
			{showInstallBanner && (
				<div
					...
					className="fixed bottom-0 left-1/2 z-50 flex w-full -translate-x-1/2 flex-col items-stretch overflow-hidden bg-theme-primary-50 px-8 text-theme-secondary-900 dim:bg-theme-dim-800 dark:bg-theme-secondary-800 sm:flex-row sm:px-0 md:mb-4 md:max-w-xl md:rounded-xl"
				>
					<button
						data-testid="InstallPWA__close"
						type="button"
						onClick={hideInstallBanner}
						className="flex shrink-0 cursor-pointer items-center justify-center p-4 text-theme-primary-600 hover:bg-theme-primary-100 hover:text-theme-primary-700 dim-hover:bg-theme-dim-900 dim-hover:text-theme-navy-600 dark:hover:bg-theme-secondary-900"
					>
						<Icon name="Cross" size="md" />
					</button>

					<div className="mb-4 sm:mb-0 sm:py-4">
						<div className="w-full border-b border-theme-secondary-300 dim:border-theme-dim-700 dark:border-theme-secondary-700 sm:h-full sm:w-auto sm:border-l" />
					</div>
