			...
			{showInstallBanner && (
				...
				>
					<button
						...
						className="text-theme-primary-600 dark:hover:bg-theme-secondary-900 hover:bg-theme-primary-100 hover:text-theme-primary-700 flex shrink-0 items-center justify-center p-4"
					>
