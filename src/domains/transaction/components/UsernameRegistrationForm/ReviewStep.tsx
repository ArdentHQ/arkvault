		...
		<section data-testid="UsernameRegistrationForm__review-step">
			...
			<div className="-mx-3 mt-6 space-y-3 sm:mx-0 sm:mt-4 sm:space-y-4">
				<TransactionAddresses
					labelClassName="w-auto sm:min-w-24 sm:pr-6"
				...
				<DetailWrapper label={t("TRANSACTION.TRANSACTION_TYPE")}>
					<div className="space-y-3 sm:space-y-0">
						<div className="flex w-full items-center justify-between gap-4 sm:justify-start">
							<DetailTitle className="w-auto sm:min-w-[84px]">{t("COMMON.CATEGORY")}</DetailTitle>
						...
						<div className="flex w-full items-center justify-between gap-4 sm:justify-start">
							<DetailTitle className="w-auto sm:min-w-[84px]">{t("COMMON.USERNAME")}</DetailTitle>
