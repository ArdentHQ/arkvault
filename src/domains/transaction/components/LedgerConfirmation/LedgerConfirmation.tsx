		...
		<>
			<div className="space-y-5">
				...
				<div
					...
					className="flex items-center space-x-3 rounded-xl border border-theme-warning-200 bg-theme-warning-50 px-4 py-5 dark:border-theme-warning-600 dark:bg-transparent"
				>
					...
					<p className="leading-4.25 font-semibold text-theme-secondary-700 dark:text-theme-warning-600 sm:leading-5">
