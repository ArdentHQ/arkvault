...
export const AddParticipantItem: VFC<{
	...
	return (
		<div
			...
			className="border-theme-secondary-300 dark:border-theme-secondary-800 mb-3 overflow-hidden rounded border bg-white last:mb-0 sm:rounded-none sm:border-x-0 sm:border-b-0 sm:border-dashed sm:bg-transparent sm:pt-3 dark:bg-black sm:dark:bg-transparent"
		>
