...
export const TransactionAddresses = ({
	...
	return (
		<DetailWrapper label={t("TRANSACTION.ADDRESSING")} className="flex flex-col gap-3">
			...
			{interactedWith && ( <div className="mt-3 flex items-center justify-between space-x-2 sm:justify-start sm:space-x-0">
				<DetailTitle className={labelClassName}>{t("COMMON.INTERACTED")}</DetailTitle>
				<Address
					truncateOnTable
