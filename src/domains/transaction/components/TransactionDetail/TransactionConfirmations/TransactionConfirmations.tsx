	...
	if (confirmations && confirmations > 1 && !transaction.isSuccess()) {
		return (
			<div
				...
				className="py-2 rounded-xl border sm:py-4 sm:leading-5 dark:bg-transparent border-theme-danger-200 bg-theme-danger-50 max-sm:text-sm dark:border-theme-danger-info-border"
			>
				<div className="flex items-center px-3 mb-2 space-x-3 sm:px-6 sm:mb-4">
				...
				<p className="px-3 pt-2 font-semibold border-t sm:px-6 sm:pt-4 border-theme-danger-200 text-theme-secondary-700 dark:border-theme-secondary-800 dark:text-theme-secondary-500">
		...
		<div className="mt-3 sm:mt-2">
			{!isConfirmed && (
				<div
					...
					className="flex items-center py-2 px-3 space-x-3 rounded-xl border sm:py-4 sm:px-6 sm:leading-5 dark:bg-transparent border-theme-warning-200 bg-theme-warning-50 max-sm:text-sm dark:border-theme-warning-600"
				>
			...
			{isConfirmed && (
				<div
					...
					className="flex items-center py-2 px-3 space-x-3 rounded-xl border sm:py-4 sm:px-6 sm:leading-5 dark:bg-transparent border-theme-success-200 bg-theme-success-50 max-sm:text-sm dark:border-theme-success-600"
				>
					...
					<p className="text-sm font-semibold sm:text-base text-theme-secondary-700 dark:text-theme-success-600">
						<span>{t("TRANSACTION.CONFIRMATIONS_COUNT", { count: confirmations })} </span>
					</p>
				</div>
			)}
