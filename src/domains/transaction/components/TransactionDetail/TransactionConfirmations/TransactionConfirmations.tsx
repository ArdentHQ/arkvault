		...
		return (
			...
			>
				<div className="mb-2 flex items-center space-x-3 px-3 sm:mb-4 sm:px-6">
					...
					<Divider
						type="vertical"
						className="h-5 text-theme-danger-200 dim:text-theme-dim-700 dark:text-theme-secondary-800"
					/>

					<p className="font-semibold text-theme-secondary-700 dim:text-theme-dim-200 dark:text-theme-secondary-500">
