...
export const Transactions = memo(function Transactions({
	...
	return (
		<>
			...
			{hasMore && (
				<div className="border-t md:border md:border-t-0 border-theme-secondary-300 dark:border-theme-secondary-800 rounded-b-xl px-6 py-4 md:-mx-px -mx-6 -mt-1 md:mt-0">
					<Button
						data-testid="transactions__fetch-more-button"
						variant="secondary"
						className="w-full leading-5 py-2"
