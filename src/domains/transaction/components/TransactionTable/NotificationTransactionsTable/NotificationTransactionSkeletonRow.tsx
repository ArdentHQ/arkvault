	...
	return (
		<TableRow className="relative">
			...
			<TableCell innerClassName="justify-end pr-8 static">
				<span className="flex h-7 items-center space-x-1 rounded border border-theme-secondary-300 px-2 dim:border-theme-dim-700 dark:border-theme-secondary-800">
