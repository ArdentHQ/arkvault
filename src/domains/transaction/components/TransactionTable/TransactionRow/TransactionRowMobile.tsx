					...
					<MobileCard className="mb-3">
						<div className="flex justify-between items-center px-4 w-full h-10 dark:bg-black bg-theme-secondary-100">
							...
							<div className="flex flex-row items-center">
								<span
									className="text-sm font-semibold sm:block text-theme-secondary-700"
						...
						<div className="flex flex-col gap-4 px-4 pt-3 pb-4 w-full sm:grid sm:pb-4 sm:grid-cols-[200px_auto_130px]">
							<MobileSection
