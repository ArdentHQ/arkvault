		...
		return (
			<TableRow onClick={onClick} className={twMerge("relative", className)} {...properties}>
				...
				<TableCell
					...
					innerClassName="text-sm text-theme-secondary-900 dark:text-theme-secondary-200 font-semibold items-start my-1 min-h-9 xl:max-h-9 xl:pt-2"
				...
				<TableCell innerClassName="items-start my-1 pt-2 min-h-14 xl:min-h-9">
					<Label
						color="secondary"
						size="xs"
						noBorder
				...
				<TableCell innerClassName="space-x-4 items-start min-h-14 my-1 pt-2 px-0 lg:px-3 xl:pt-0 xl:min-h-9 xl:items-center">
