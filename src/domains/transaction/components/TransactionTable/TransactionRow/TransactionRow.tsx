	...
	({
		...
		return (
			<TableRow onClick={onClick} className={twMerge("relative", className)} {...properties}>
				...
				<TableCell innerClassName={cn("items-start xl:min-h-11 xl:pt-3", {
				...
				<TableCell
					variant="end"
					innerClassName={cn("justify-end items-start text-sm text-theme-secondary-900 dark:text-theme-secondary-200 font-semibold xl:min-h-11 xl:my-0 xl:pt-3", {
						"min-h-[66px] py-2 my-0": !hideSender,
						"min-h-14 my-1 pt-2": hideSender,
					})}
				>
