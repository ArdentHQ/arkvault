...
const ValidatorLabel = ({ username, count }: { username?: string; count?: number }) => (
	<span className="pl-2 ml-2 font-semibold truncate border-l border-theme-secondary-300 text-theme-secondary-500 dark:border-theme-secondary-800 dark:text-theme-secondary-700">
		{username}
	...
	if (transaction?.isMultiPayment()) {
		return (
			<span>
				...
				<span className="ml-1 font-semibold text-theme-secondary-500 dark:text-theme-secondary-700 dim:text-theme-dim-50">
