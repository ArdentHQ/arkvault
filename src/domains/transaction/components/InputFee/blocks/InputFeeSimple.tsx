			...
			{Object.entries(options).map(([optionValue, { label, displayValue, displayValueConverted }]) => {
				...
				return (
					<ButtonGroupOption
						...
						className="group dark:border-theme-dark-700 dark:group-hover:bg-theme-dark-700 dark:aria-checked:border-theme-dark-400 dark:aria-checked:bg-theme-dark-800 dim:border-theme-dim-700 dim-hover:bg-theme-dim-700 dim-hover:text-theme-dim-50 p-0"
					...
					>
						<div
							className={cn(
								...
								{
									"dark:group-hover:text-theme-dark-50 dim:text-theme-dim-50": !isSelected,
								},
							)}
						>
								...
								{!loading && (
									<div className="flex justify-between sm:w-full">
										...
										<Amount
											...
											value={displayValue}
											className={cn(
												"sm:text-theme-secondary-500 dim:sm:text-theme-dim-200 hidden text-xs leading-[15px] transition-all sm:block",
												{
													"dark:group-hover:text-theme-dark-200 sm:dark:text-theme-dark-500 dim:sm:dark:text-theme-dim-50":
														!isSelected,
												},
											)}
										/>
							...
							<div
								className={cn(
									...
									{
										"bg-theme-navy-100 dark:bg-theme-dark-500 dim:bg-theme-dim-950": isSelected,
										"bg-theme-navy-50 dark:bg-theme-dark-800 dark:group-hover:bg-theme-dark-600 dark:group-hover:text-theme-dark-50 dim:bg-theme-dim-700 dim-hover:bg-theme-dim-700 dim-hover:text-theme-dim-50":
											!isSelected,
									},
								)}
							>
