...
export const ContractAddressHint = ({ token, link }: { token: WalletToken; link: string }) => {
	...
	return (
		<div className="flex h-[33px] items-center justify-between rounded-b border border-t-0 border-theme-secondary-400 bg-theme-secondary-200 px-3 py-2 text-xs leading-[15px] dim:border-theme-dark-500 dim:bg-theme-dim-950 dark:border-theme-dark-500 dark:bg-theme-dark-950 sm:px-4 sm:text-sm sm:leading-[17px]">
