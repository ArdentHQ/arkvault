...
describe("CsvFormatter", () => {
	...
	it("should use zero rate if transaction total is zero", () => {
		vi.spyOn(transaction, "total").mockReturnValue(BigNumber.make(0));
