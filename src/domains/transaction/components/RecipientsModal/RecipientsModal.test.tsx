...
describe("RecipientsModal", () => {
	it("should render `RecipientsLists` in `sm` screen", () => {
		renderResponsive(<RecipientsModal recipients={recipients} ticker="DARK" isOpen={true} onClose={vi.fn()}/>, "sm");
	...
	it("should render `RecipientsTable` in `lg` screen", () => {
		renderResponsive(<RecipientsModal recipients={recipients} ticker="DARK" isOpen={true} onClose={vi.fn()}/>, "lg");
