...
describe("Registration", () => {
	...
	it("should show mnemonic error", async () => {
		...
		await userEvent.paste(screen.getByTestId("Input__username"), "username");
		...
		await userEvent.paste(mnemonic, MNEMONICS[0]);
		...
		await userEvent.paste(secondMnemonic, MNEMONICS[2]);
	...
	it("should prevent going to the next step with enter on the success step", async () => {
		...
		await userEvent.paste(mnemonicInput, passphrase);
	...
	it("should show error step and go back", async () => {
		...
		await userEvent.paste(screen.getByTestId("Input__username"), "delegate");
