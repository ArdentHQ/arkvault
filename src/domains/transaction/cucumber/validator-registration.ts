...
cucumber(
	"@validatorRegistration",
	{
		...
		"When she enters valid public key": async (t: TestController) => {
			...
			await t.expect(Selector("[data-testid=DetailWrapper]").withText("b387dc09d41dc443a0bb972f5bcce2b06620e2f1711a0596e96275c5ab38d4c85ccbe2d5f92d6f02dee4853acf1a14d9").exists).ok();
			await t.click(Selector("button").withText(translations.COMMON.CONTINUE));
		},
	...
	[
		...
		mockRequest("https://dwallets-evm.mainsailhq.com/api/transactions?page=1&limit=10&to=0xcd15953dD076e56Dc6a5bc46Da23308Ff3158EE6&address=0xcd15953dD076e56Dc6a5bc46Da23308Ff3158EE6,0xA46720D11Bc8408411Cbd45057EeDA6d32D2Af54,0x659A76be283644AEc2003aa8ba26485047fd1BFB", {}),
		mockRequest(
			{
				method: "POST",
		...
		mockRequest("https://dwallets-evm.mainsailhq.com/api/transactions/adb9bdd390ef3176be04b2ea841d7cd48dc72a8fdf4f145a8eece22f3c58df14", {
			data: {
		...
		mockRequest("https://dwallets-evm.mainsailhq.com/api/blocks/05b124023ddd656c8a95664eb61846cc0f4e204341a0d86db325771077e7f002", {}),
	],
);
...
cucumber("@validatorRegistration-usedPublicKey", {
	...preSteps,
