...
describe("ImportProfile", () => {
	...
	it("should request and set password for importing password protected profile", async () => {
		...
		await userEvent.paste(screen.getByTestId("PasswordModal__input"), validPassword);
	...
	it("should fail profile import and show error", async () => {
		...
		await userEvent.paste(screen.getByTestId("PasswordModal__input"), wrongPassword);
