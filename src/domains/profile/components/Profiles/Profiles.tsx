...
const ProfilesSlider = (properties: ProfilesSliderProperties) => {
	const settings: Settings = {
		...
		autoplay: false,
		customPaging: () => (
			<button className="mt-3 h-3 w-3 rounded-full border-2 border-theme-navy-200 hover:border-transparent hover:bg-theme-navy-700 dim:border-theme-dim-200 dim-hover:border-theme-dim-navy-600 dim-hover:bg-theme-dim-navy-600 dark:border-theme-secondary-600 dark:hover:border-transparent dark:hover:bg-theme-secondary-600" />
		),
		dots: true,
