...
export const ProfileRowSkeleton = () => (
	...
	>
		...
		<Icon
			name="EllipsisVerticalFilled"
			className="mr-1.5 pr-1.5 text-theme-secondary-300 transition-colors duration-200 group-hover:text-theme-navy-700 dark:text-theme-secondary-800 dark:group-hover:text-theme-secondary-200"
			size="md"
		/>
	</div>
);
