			...
			<div className="flex h-full w-full min-w-0 items-center justify-between">
				...
				{profile.usesPassword() && (
					<Icon
						...
						name="Lock"
						className="border-r border-theme-secondary-300 pr-3 text-theme-secondary-900 dim:border-theme-dim-700 dim:text-theme-dim-200 dark:border-theme-secondary-800 dark:text-theme-dark-200"
						size="lg"
					/>
				)}
			</div>
				...
				toggleContent={
					...
					>
						<Icon
							...
							className="text-theme-secondary-700 transition-colors duration-200 group-hover:text-theme-navy-700 dim:text-theme-dim-200 dark:text-theme-secondary-600 dark:group-hover:text-theme-secondary-200"
							size="md"
						/>
					</div>
				}
...
export const ProfileRowSkeleton = () => (
	<div
		...
		className="flex items-center justify-between rounded-lg border border-theme-secondary-200 p-1 dim:border-theme-dim-700 dark:border-theme-secondary-800"
	>
		<div className="h-10 w-10 rounded bg-theme-secondary-100 dim:bg-theme-dim-800 dark:bg-theme-secondary-800" />
		<Icon
			name="EllipsisVerticalFilled"
			className="mr-1.5 pr-1.5 text-theme-secondary-700 transition-colors duration-200 group-hover:text-theme-navy-700 dim:text-theme-dim-200 dark:text-theme-secondary-600 dark:group-hover:text-theme-secondary-200"
			size="md"
		/>
	</div>
);
