		...
		<header data-testid="WalletHeader" className="lg:container md:px-10 md:pt-8">
			<div className="flex flex-col gap-3 bg-theme-primary-100 px-2 py-3 dark:bg-theme-dark-950 sm:gap-2 md:rounded-xl">
				...
				<div className="flex flex-col gap-0.5">
					<div className="flex w-full flex-col gap-3 rounded bg-white p-4 md:rounded-b-sm md:rounded-t-lg">
						<div className="flex w-full flex-row items-center justify-between">
							<div className="flex flex-row items-center gap-1.5">
								<p className="hidden text-sm font-semibold leading-[17px] text-theme-secondary-700 sm:block md:text-base md:leading-5">
									{t("COMMON.ADDRESS")}
								</p>
								<div className="h-[17px] w-32 md:h-5 md:w-60 lg:w-125">
									<Address
										...
										address={wallet.address()}
										truncateOnTable
										addressClass="text-theme-primary-900 text-sm font-semibold leading-[17px] md:text-base md:leading-5"
									/>
								</div>
								<WalletIcons
									wallet={wallet}
						...
						<div className="flex flex-col gap-3 sm:w-full sm:flex-row sm:items-center sm:justify-between sm:gap-0">
							<div className="flex flex-col gap-3 sm:gap-2" data-testid="WalletHeader__balance">
								<div className="flex flex-row items-center text-sm font-semibold leading-[17px] text-theme-secondary-700">
									...
									<Divider type="vertical" className="h-3 border-theme-secondary-300 md-lg:hidden" />
									<Amount
					...
					<div className="hidden w-full rounded-b-lg rounded-t-sm bg-white p-4 md:block">
						<WalletVote
							wallet={wallet}
