...
export const ValidatorStatusIcon = ({ votes, activeValidators }: ValidatorStatusProperties) => {
	...
	if (activeCount === votes.length) {
		return (
			<div data-testid="ValidatorStatusIcon-Active" className="bg-theme-success-100 dark:border-theme-success-800 dim:border-theme-success-800 flex h-5 w-5 items-center justify-center rounded-sm border border-transparent dark:bg-transparent">
	...
	if (standbyCount === votes.length) {
		return (
			<div data-testid="ValidatorStatusIcon-StandBy" className="bg-theme-warning-100 dark:border-theme-warning-800 dim:border-theme-warning-800 flex h-5 w-5 items-center justify-center rounded-sm border border-transparent dark:bg-transparent">
	...
	if (resignedCount === votes.length) {
		return (
			<div data-testid="ValidatorStatusIcon-Resigned" className="bg-theme-danger-100 dark:border-theme-danger-800 dim:border-theme-danger-800 flex h-5 w-5 items-center justify-center rounded-sm border border-transparent dark:bg-transparent">
