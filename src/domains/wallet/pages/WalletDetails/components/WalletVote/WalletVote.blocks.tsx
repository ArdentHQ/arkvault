...
const Votes = ({ votes, activeDelegates }: VotesProperties) => {
	...
	return (
		<div className="mb-3 flex w-full flex-col items-start justify-between gap-0 overflow-hidden rounded-xs border border-theme-secondary-300 dark:border-theme-dark-700 md:mb-0 md:flex-row md:items-center md:gap-2 md:rounded-none md:border-none">
