...
export const ReceiveFunds = ({ address, name, network, onClose }: ReceiveFundsProperties) => {
	...
	return (
		...
		>
			<div
				className="rounded-xl border border-theme-secondary-300 px-6 py-4 dim:border-theme-dim-700 dark:border-theme-secondary-800"
			...
			{isFormOpen && (
				<>
					<div className="mx-auto mt-4 max-w-sm text-center text-theme-secondary-600 dim:text-theme-dim-200">
						{t("COMMON.QR_CODE_HELP_TEXT")}
					</div>

					<div className="mt-4 h-14 border border-transparent">
						<div
							className="flex max-w-full overflow-auto rounded-lg border border-theme-secondary-300 font-medium dim:border-theme-dim-700 dark:border-theme-secondary-800"
							data-testid="ReceiveFundsForm__uri"
						>
							<div className="bg-theme-secondary-200 px-4 py-4.5 leading-5 dim:bg-theme-dim-950 dark:bg-theme-secondary-800">
							...
							<div className="flex grow items-center justify-between space-x-4 overflow-auto bg-theme-secondary-100 pl-6 pr-5 dark:bg-theme-background">
								{!!uri && (
									<>
										...
										<span className="flex text-theme-primary-300 hover:text-theme-primary-700 dim:text-theme-dim-navy-600 dim-hover:text-theme-dim-navy-700 dark:text-theme-secondary-600">
