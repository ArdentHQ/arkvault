export const translations = {
	...
	PAGE_WALLET_DETAILS: {
		...
		VOTES: {
			...
			EMPTY_DESCRIPTION_DELEGATE: "You have not voted for a Delegate yet.",
			...
			NOT_FORGING_COUNT_DELEGATE: "{{count}} of your delegates are currently not in a forging position",
