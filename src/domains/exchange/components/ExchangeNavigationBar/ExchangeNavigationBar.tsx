...
export const ExchangeNavigationBar = ({ currentView, onChange }: ExchangeNavigationBarProperties) => {
	...
	return (
		<div className="border-theme-secondary-300 bg-theme-secondary-200 dark:border-theme-dark-700 -mx-6 -mt-2 mb-4 border-t px-6 py-2 md:mx-0 md:mt-0 md:mb-3 md:border-t-0 md:bg-transparent md:p-0 md:px-0 md:py-0 dark:bg-black dark:md:bg-transparent">
