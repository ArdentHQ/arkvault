...
export const ExchangeNavigationBar = ({ currentView, onChange }: ExchangeNavigationBarProperties) => {
	...
	return (
		<div className="-mx-6 mb-4 border-t border-theme-secondary-300 bg-theme-secondary-200 px-6 py-2 dark:border-theme-dark-700 dark:bg-black md:mx-0 md:mb-3 md:mt-0 md:border-t-0 md:bg-transparent md:p-0 md:px-0 md:py-0 dark:md:bg-transparent">
