...
export const ConfirmationStep = ({ exchangeTransaction }: ConfirmationStepProperties) => {
	...
	return (
		<div data-testid="ExchangeForm__confirmation-step" className="flex flex-col space-y-8">
			<div className="sm:mx-auto sm:flex sm:items-center sm:space-x-3">
				<Icon name="CircleCheckMark" size="xl" className="hidden text-theme-success-600 sm:block" />
				<h2 className="m-0 text-xl font-bold sm:text-2xl">
					{t("EXCHANGE.EXCHANGE_FORM.TRANSACTION_COMPLETE")}
				</h2>
			</div>

			<div className="flex flex-col space-y-5">
				<div className="flex items-center space-x-3">
					<span className="flex h-6 w-6 items-center justify-center rounded bg-theme-primary-200 font-semibold dark:bg-theme-secondary-800">
						1
					</span>
				...
				<div className="flex sm:space-x-6">
					<div className="hidden h-24 w-24 shrink-0 items-center justify-center rounded-xl bg-theme-secondary-200 dark:bg-theme-secondary-700 sm:flex">
