...
describe("General Settings", () => {
	...
	it("should render with prompt paths", async () => {
		...
		await userEvent.paste(nameInput(), "My Profile");
	...
	it("should update profile", async () => {
		...
		await userEvent.paste(nameInput(), "test profile");
		...
		await userEvent.paste(nameInput(), "test profile 2");
	...
	it("should not update profile if profile name exists", async () => {
		...
		(nameInput() as HTMLInputElement).select();
		await userEvent.paste(nameInput(), otherProfile!.name());
		...
		(nameInput() as HTMLInputElement).select();
		await userEvent.paste(nameInput(), "unique profile name");
	...
	it("should not update profile if profile name exists (uppercase)", async () => {
		...
		(nameInput() as HTMLInputElement).select();
		await userEvent.paste(nameInput(), otherProfile!.name().toUpperCase());
	...
	it("should not update profile if profile name is too long", async () => {
		...
		(nameInput() as HTMLInputElement).select();
		await userEvent.paste(nameInput(), "test profile".repeat(10));
