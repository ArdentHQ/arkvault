...
const NodeStatusNode = ({ network, hosts }: { network: Networks.Network; hosts: HostGroup }) => {
	...
	return (
		<div
			...
			className="flex items-center space-x-3 rounded-lg border border-theme-secondary-300 px-4 py-3 leading-none text-theme-secondary-700 dim:border-theme-dim-700 dim:text-theme-dim-200 dark:border-theme-dark-700 dark:text-theme-dark-200"
		>
				...
				{results.every((r) => r === true) && (
					<Tooltip content={t("SETTINGS.SERVERS.NODE_STATUS_TOOLTIPS.HEALTHY")}>
						<div data-testid="NodeStatus--statusok">
							<Icon
								name="StatusOk"
								className="text-theme-success-600 dim:text-theme-success-500 dark:text-theme-success-500"
								size="lg"
							/>
						</div>
					</Tooltip>
			...
			<div className="flex items-center">
				<button
					...
					className="transition-colors hover:text-theme-primary-700 dim:hover:text-theme-dim-50 dark:hover:text-theme-dark-50"
				>
