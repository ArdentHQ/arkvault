...
describe("Contacts", () => {
	...
	it("should search for contact by name", async () => {
		...
		searchInput().select();
		await userEvent.paste(searchInput(), contact1.name());
		...
		searchInput().select();
		await userEvent.paste(searchInput(), "Unknown Name");
	...
	it("should search for contact by address", async () => {
		...
		searchInput().select();
		await userEvent.paste(searchInput(), contact1Address);
		...
		searchInput().select();
		await userEvent.paste(searchInput(), "Unknown Address");
