						...
						<StepsProvider steps={selectedWallet?.isLedger() ? 3 : 2} activeStep={activeTab}>
							...
							{activeTab === Step.SuccessStep && (
								<FormButtons>
									...
									>
										<div
											className="relative inline-flex items-center space-x-3 rounded-xs bg-theme-primary-600 text-center text-base font-semibold text-white hover:bg-theme-primary-700"
